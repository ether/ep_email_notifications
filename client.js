...
exports.eejsBlock_styles = function (hook_name, args, cb) {
  args.content += '<link href="../static/plugins/ep_email_notifications/static/css/email_notifications.css" rel="stylesheet">';
};

exports.clientVars = function (hook, context, callback) {
  const pluginSettings = settings.ep_email_notifications;
  const panelDisplayLocation = (pluginSettings && pluginSettings.panelDisplayLocation) ? pluginSettings.panelDisplayLocation : 'undefined';
  // return the setting to the clientVars, sending the value
  return callback({panelDisplayLocation});
};
